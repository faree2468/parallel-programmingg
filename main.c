...
int main(int argc, char *argv[]){
    ...
    mymindt = timestep1(NCELLS, g, sigma, celltype, H, U, V, dx, dy);

    printf("Minimum dt for timestep1 is  %lf\n",mymindt);

    mymindt = timestep2(NCELLS, g, sigma, celltype, H, U, V, dx, dy);

    printf("Minimum dt for timestep2 is %lf\n",mymindt);

    mymindt = timestep3(NCELLS, g, sigma, celltype, H, U, V, dx, dy);
