...
pointer iarray was not freed
ival and ipos values were not initialized to 0 because it cant be uninitialized
loop went to 10, and last index that can be accessed is 9 (from 0 to 9)
